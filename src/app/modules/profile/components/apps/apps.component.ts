...
import { addMusicApp, deleteMusicApp, fetchMusicApps, updateIsConnected } from '../../store/actions/music-apps.actions';
...
export class AppsComponent extends Unsubscribeable {
  ...
  onRemove(appId: number): void {
    this.store.dispatch(deleteMusicApp({ musicAppId: appId }));
  }
